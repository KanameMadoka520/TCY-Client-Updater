...
def build_system_overview(system_input, client_input):
    ...
    client_info = {
        ...
        "launcher_name": str(client_input.get("launcher_name") or ""),
        "launcher_profile": str(client_input.get("launcher_profile") or ""),
        "launcher_selected_version": str(client_input.get("launcher_selected_version") or ""),
        "launcher_setting_source": str(client_input.get("launcher_setting_source") or ""),
        "launcher_java_mode": str(client_input.get("launcher_java_mode") or ""),
        "launcher_config_path": str(client_input.get("launcher_config_path") or ""),
        "launcher_java_path": str(client_input.get("launcher_java_path") or ""),
        "launcher_profile_path": str(client_input.get("launcher_profile_path") or ""),
        "launcher_jvm_args": str(client_input.get("launcher_jvm_args") or ""),
